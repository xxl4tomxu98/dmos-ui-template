...
declare module '@okta/okta-signin-widget' {
  declare class OktaSignIn implements OktaSignIn {
    ...
    off(
      event?: 'afterError',
      callback?: OktaSignIn.EventCallbackWithError,
    ): void;
    ...
    showSignInToGetTokens(
      options: OktaSignIn.ShowSignInToGetTokensOptions,
    ): Promise<Tokens>;
    showSignInAndRedirect(
      options: OktaSignIn.ShowSignInAndRedirectOptions,
    ): Promise<void>;
    renderEl(
  ...
  declare namespace OktaSignIn {
    ...
    type Scope = 'openid' | 'email' | 'profile' | 'address' | 'phone';
    ...
    type IdpDisplay = 'PRIMARY' | 'SECONDARY';
    interface Piv {
      certAuthUrl: string;
      text?: string;
      className?: string;
    ...
    // Types for config
    type UserOperation = 'PRIMARY_AUTH' | 'FORGOT_PASSWORD' | 'UNLOCK_ACCOUNT';
    ...
    // Events
    type Event = 'ready' | 'afterError' | 'afterRender';
    ...
    namespace Registration {
      ...
      interface FieldStringWithFormatAndEnum
        extends FieldBasic,
          EnumConstraint<string>,
          WithDefault<string> {
      ...
      interface FieldNumber
        extends FieldBasic,
          NumberConstraint,
          EnumConstraint<number>,
          WithDefault<number> {
        type: 'number' | 'integer';
      }
      interface FieldBoolean
        extends FieldBasic,
          EnumConstraint<boolean>,
          WithDefault<boolean> {
        type: 'boolean';
      }
    ...
    type RenderStatus =
      ...
      | 'SUCCESS';
    type RenderType = 'SESSION_STEP_UP' | 'SESSION_SSO';
    ...
    interface RenderResultSuccessNonIDCStepUp
      extends RenderResultSuccessNonIDCBasic {
    ...
    interface RenderResultSuccessNonIDCRedirect
      extends RenderResultSuccessNonIDCBasic {
      next?: SimpleCallback;
    }
    interface RenderResultSuccessNonIDCSession
      extends RenderResultSuccessNonIDCBasic {
      // type: 'SESSION_SSO';
      session?: {
        token: string;
    ...
    type RenderResultSuccessNonIDC = RenderResultSuccessNonIDCStepUp &
      RenderResultSuccessNonIDCRedirect &
      RenderResultSuccessNonIDCSession;
    type RenderResultSuccess = RenderResultSuccessOIDC &
